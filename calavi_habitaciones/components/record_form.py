            ...
            rx.el.div(
                ...
                rx.el.div(
                    rx.el.button(
                        ...
                        class_name="rounded-lg border border-neutral-300 bg-neutral-100 px-4 py-2 text-sm font-semibold text-neutral-700 hover:bg-neutral-50",
                    ),
                    rx.el.button(
...
def record_form() -> rx.Component:
    return rx.el.form(
        ...
        rx.el.div(
            ...
            class_name="sticky bottom-0 flex items-center justify-end gap-3 border-t border-neutral-200 bg-neutral-100 px-5 py-4 sm:px-6",
        ),
        ...
        rx.el.div(
            rx.el.div(
                rx.el.div(
                    ...
                    class_name="sticky top-0 z-10 flex items-start justify-between gap-3 border-b border-neutral-200 bg-neutral-100 px-5 py-4 sm:px-6",
                ),
                record_form(),
                room_subform_dialog(),
                tenant_subform_dialog(),
                class_name="max-h-[88vh] w-full max-w-3xl overflow-y-auto rounded-xl border border-neutral-200 bg-neutral-100",
            ),
