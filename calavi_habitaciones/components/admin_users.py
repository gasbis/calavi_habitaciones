    ...
    return rx.el.tr(
        ...
        rx.el.td(
            rx.el.button(
                ...
                class_name="flex w-fit items-center gap-2 rounded-lg border border-neutral-300 bg-neutral-100 px-3 py-2 text-xs font-semibold text-neutral-700 transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-brand-700 disabled:cursor-not-allowed disabled:opacity-50",
            ),
            class_name="px-4 py-4 align-top sm:px-5",
        ),
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.form(
                    ...
                    rx.el.div(
                        rx.el.button("Cancelar", type="button", on_click=AuthState.close_new_admin, class_name="rounded-lg border border-neutral-300 bg-neutral-100 px-4 py-2 text-sm font-semibold text-neutral-700 hover:bg-neutral-50"),
