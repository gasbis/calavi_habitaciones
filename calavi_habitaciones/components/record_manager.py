        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.el.button(
                    ...
                    class_name="rounded-lg border border-danger-200 bg-white px-3 py-2 text-xs font-semibold text-danger-700 transition-colors hover:bg-danger-50",
                ),
        ...
        rx.el.form(
            rx.el.div(
                rx.el.div(
                    ...
                    rx.el.input(
                        ...
                        class_name="mt-2 w-full rounded-lg border border-archive-200 bg-white px-3 py-2 text-sm font-medium text-neutral-900 outline-hidden focus:border-brand-500 focus:ring-2 focus:ring-brand-200",
                    ),
                ...
                rx.el.div(
                    ...
                    rx.el.textarea(
                        ...
                        class_name="mt-2 w-full resize-none rounded-lg border border-archive-200 bg-white px-3 py-0.5 text-sm font-medium text-neutral-900 placeholder:text-neutral-400 outline-hidden focus:border-brand-500 focus:ring-2 focus:ring-brand-200",
                    ),
            ...
            rx.el.div(
                ...
                rx.el.button(
                    ...
                    class_name="rounded-lg border border-archive-200 bg-white px-3 py-2 text-xs font-semibold text-archive-700 transition-colors hover:bg-archive-100",
                ),
                class_name="mt-3 flex flex-wrap items-center gap-2",
            ),
        ...
        rx.el.form(
            rx.el.div(
                rx.el.input(
                    ...
                    class_name="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm font-medium text-neutral-700 outline-hidden focus:border-brand-500 focus:ring-2 focus:ring-brand-200",
                ),
            ...
            rx.el.div(
                ...
                rx.el.button(
                    ...
                    class_name="rounded-lg border border-brand-200 bg-white px-3 py-2 text-xs font-semibold text-brand-700 transition-colors hover:bg-brand-100",
                ),
                class_name="mt-3 flex flex-wrap items-center gap-2",
            ),
        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.el.button(
                    ...
                    class_name="flex w-full items-center justify-center gap-2 rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm font-semibold text-neutral-700 transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-brand-700 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto",
                ),
                rx.el.button(
                ...
                rx.el.button(
                    ...
                    disabled=~OccupancyState.has_selection,
                    class_name="flex w-full items-center justify-center gap-2 rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm font-semibold text-neutral-700 transition-colors hover:border-archive-300 hover:bg-archive-50 hover:text-archive-700 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto",
                ),                
                rx.el.button(
                    rx.icon("trash-2", class_name="h-4 w-4"),
                    rx.el.span("Borrar registro"),
                    ...
                    disabled=~OccupancyState.has_selection,
                    class_name="flex w-full items-center justify-center gap-2 rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm font-semibold text-neutral-700 transition-colors hover:border-danger-300 hover:bg-danger-50 hover:text-danger-700 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto",
                ),
