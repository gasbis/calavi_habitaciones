    ...
    return rx.el.div(
        ...
        rx.el.div(
            ...
            rx.el.input(
                ...
                required=True,
                class_name="w-full rounded-lg border border-neutral-300 bg-neutral-100 py-2.5 pl-9 pr-3 text-sm font-medium text-neutral-900 placeholder:text-neutral-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-200 outline-hidden",
            ),
    ...
    return rx.el.main(
        rx.el.div(
            ...
            rx.el.div(
                ...
                class_name="mt-12 w-full rounded-xl border border-neutral-200 bg-neutral-100 p-6 sm:p-8",
            ),
