...
def history_card(item: Lease) -> rx.Component:
    return rx.el.button(
        rx.el.div(
            rx.el.div(
                rx.icon("archive", class_name="h-5 w-5 text-archive-600"),
                class_name="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-archive-100 bg-archive-50",
            ),
            rx.el.div(
                rx.el.p(
        ...
        rx.el.div(
            rx.el.span(
                "Finalizado",
                class_name="w-fit rounded-full border border-archive-200 bg-archive-100 px-2.5 py-1 text-xs font-semibold text-archive-700",
            ),
            rx.el.p(
                f"{item['termination_date']}",
                class_name="mt-3 text-left text-xs font-medium text-neutral-500",
            ),
            class_name="mt-4 border-t border-neutral-100 pt-4",
        ),
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.button(
                    ...
                    class_name="flex h-8 w-8 items-center justify-center rounded-lg border border-neutral-200 text-neutral-500 hover:bg-neutral-50",
                ),
            ...
            rx.el.div(
                rx.el.div(
                    rx.image(
                        ...
                        class_name="size-12 rounded-full bg-neutral-100",
                    ),
                    rx.el.div(
                        rx.el.p(
                ...
                rx.el.div(
                    ...
                    rx.el.p(
                        ...
                        class_name="mt-2 text-sm font-semibold text-neutral-700",
                    ),
                    rx.el.p(
                ...
                rx.el.div(
                    ...
                    rx.el.p(
                        ...
                        class_name="mt-2 text-sm font-semibold text-neutral-900",
                    ),
                    rx.el.p(
                        OccupancyState.selected_history_room["tenant_phone"],
                        class_name="mt-1 text-sm font-medium text-neutral-600",
                    ),
                    rx.el.p(
                        OccupancyState.selected_history_room["notes"],
                        class_name="mt-4 rounded-lg border border-brand-100 bg-brand-50 p-3 text-sm leading-relaxed text-neutral-700",
                    ),
...
def history_view() -> rx.Component:
    return rx.el.section(
        rx.el.div(
            rx.el.div(
                rx.icon("archive", class_name="h-5 w-5 text-brand-600"),
                rx.el.div(
                    rx.el.h2(
                        "Contratos finalizados",
                        class_name="text-xl font-semibold text-neutral-900",
                    ),
                    rx.el.p(
