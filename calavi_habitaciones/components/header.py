            ...
            rx.el.div(
                rx.el.div(
                    rx.el.span(
                        ...
                        class_name="flex w-fit items-center gap-1.5 rounded-full border border-gray-200 bg-white px-2.5 py-1",
                    ),
                    rx.image(
                    ...
                    rx.el.button(
                        ...
                        class_name="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900",
                    ),
    ...
    return rx.el.div(
        rx.el.div(
            rx.el.h1(
                ...
                class_name="text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl",
            ),
            rx.el.p(
                ...
                class_name="mt-1 max-w-2xl text-sm font-medium text-gray-500",
            ),
            class_name="min-w-0",
        ),
        rx.el.div(
